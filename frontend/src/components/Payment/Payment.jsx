...
const Payment = () => {
  ...
  const[agelimitlow, setagelimitlow] = useState(false);
  ...
  const handleImageUpload = async () => {
    ...
    fileReader.onload = async () => {
      ...
      setagelimit(randomAge);
      const orderData = JSON.parse(localStorage.getItem("latestOrder"));
    for (let i = 0; i < orderData.cart.length; i++) {
      const product = orderData.cart[i];
      if (product.agelimit !== undefined) {
        if(product.agelimit > agelimit){
          document.getElementsByClassName("hideBlok")[0].remove();
         
        }
              
        
        console.log("Product " + (i + 1) + " agelimit: " + product.agelimit);
      }
    }
     if(agelimitlow){
      ...
      <Box sx={{ mt: 4, textAlign: "center" }}>
        ...
        {result && (
          <Paper sx={{ mt: 4, p: 2 }}>
            ...
            <pre>{JSON.stringify(result, null, 2)}{console.log(result)}</pre>
          </Paper>
        )}
      </Box>
    </Container>
...
<<<<<<< HEAD
   <>
    <p id="hideText"></p>
    <div className="w-full 800px:w-[95%] bg-[#fff] rounded-md p-5 pb-8 hideBlok">
     
=======
    <div className="w-full 800px:w-[95%] cch rounded-md p-5 pb-8">
>>>>>>> a39b01ff4eef541431aee654260e3443fc9825cb
      ...
      <div>
        <div className="flex w-full pb-5 border-b mb-2">
          ...
          <h4 className="text-[18px] pl-2 font-[600] text-[#000000b1] cw">
  ...
  return (
    <div className="w-full bg-[#fff] rounded-md p-5 pb-8">
      <div className="flex justify-between">
        ...
        <h5 className="text-[18px] font-[600] text-[#000000a4]">${orderData?.subTotalPrice}</h5>
      </div>
      <br />
      <div className="flex justify-between">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">shipping:</h3>
        <h5 className="text-[18px] font-[600] text-[#000000a4]">${shipping}</h5>
      </div>
      <br />
      <div className="flex justify-between border-b pb-3">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">Discount:</h3>
        <h5 className="text-[18px] font-[600] text-[#000000a4]">{orderData?.discountPrice? "$" + orderData.discountPrice : "-"}</h5>
      </div>
